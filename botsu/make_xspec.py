...
merged_data = pd.concat([pre_data, data, post_data], ignore_index=True)
...
bg_counts = fits.Column(name='COUNTS', array=bg_pre_hist[0]+bg_post_hist[0], format='J')
...
bg_spectrum.header.append(('EXPOSURE',3600.0,'exposure (in seconds)'))
